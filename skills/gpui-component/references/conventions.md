...
Use the [usage guide](usage.md) for imports, retained ownership, initialization, Root, and overlay layers. For a narrow task, load its component page and the relevant section of the coding/design guides; a component catalog is not a required reading sequence.
...
In this repository, the control-family and Form tests verify these conventions as deterministic contract checks, not measured AI first-attempt success rates.
